...
async function handleLoad(){
  ...
  .then((data) => {
    ...
    if(data.is_open_sauced_member){
      ...
      openSaucedProfileButton.style = 'width: 100%; background-color: #2ea44f; color: white; border: none; padding: 10px 20px; border-radius: 5px; margin-top: 10px; cursor: pointer; font-size: 16px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; transition: all 0.3s ease-in-out;';
